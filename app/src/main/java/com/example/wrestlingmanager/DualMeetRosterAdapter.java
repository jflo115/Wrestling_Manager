...
public class DualMeetRosterAdapter extends BaseAdapter {
    ...
    public DualMeetRosterAdapter(Context context, List<Wrestler> roster) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view == null){
            ...
            view = inflater.inflate(R.layout.dual_meet_roster_list,null);
            holder.name = (TextView) view.findViewById(R.id.DualMeetRosterWrestler);
            view.setTag(holder);
        } else {
